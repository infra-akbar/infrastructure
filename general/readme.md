...
| Name | Type |
|------|------|
| [azurerm_app_service_plan.appplan](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/app_service_plan) | resource |
...
|------|-------------|------|---------|:--------:|
| <a name="input_appplan_name"></a> [appplan\_name](#input\_appplan\_name) | n/a | `any` | n/a | yes |
